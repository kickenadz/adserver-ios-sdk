...
//  Swift Sample
//
//  Created by LEO HONG on 11/8/19.
//  Copyright © 2019 kickenadz. All rights reserved.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func requestPixelTapped(_ sender: Any) {
        guard let url = URL(string: "https://servedbykickenadz.com/default_banner.gif") else {
